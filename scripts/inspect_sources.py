...
def main() -> int:
    ...
    print(json.dumps({"scope": scope.value, "readable": [source for source in sources if can_read_source(scope, source)], "tables_are_allowlisted": True, "service_role_used": False}, indent=2))
    return 0
